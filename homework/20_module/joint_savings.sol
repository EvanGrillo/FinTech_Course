...
contract JointSavings {
    ...
    */
    function withdraw(uint amount, address payable recipient) public payable {
        ...
        //- 
        require(!lock, "Exiting...procedure locked.");
        ...
        */
        require(recipient == accountOne || recipient == accountTwo, "Exiting...unauthorized account.");
        /*
        ...
        */
        require((contractBalance - amount) > 0, "Insufficient funds for withdraw");
